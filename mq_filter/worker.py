...
class Worker:
    ...
    def move_messages(self, session, mailer):
        ...
        qmgr = pymqi.connect(
            queue_manager = queue_manager.manager_name,
            channel = queue_manager.channel.name,
            conn_info = queue_manager.connection.as_string(),
        )
            ...
            try:
                ...
                if not parser:
                    ...
                    try:
                        ...
                        rule.destination_queue.put(qmgr, db_message.message_bytes)
                        ...
                        source_queue.get_message(qmgr, md.MsgId)
                    except Exception:
                        logger.exception(
